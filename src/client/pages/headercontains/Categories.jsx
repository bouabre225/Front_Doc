...
const CATEGORIES_CONFIG = {
  ...
  pharmacie:          { name: 'Pharmacie',          color: 'from-pink-500 to-rose-600',     bgLight: 'bg-pink-50',     textColor: 'text-pink-500',   emoji: '💊',  image: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=800&fit=crop' },
