      ...
      >
        ...
        <div className='p-8 bg-white border border-gray-100 shadow-xl rounded-2xl'>
          {!success ? (
            ...
            >
              ...
              <h2 className='mb-3 text-2xl font-bold text-gray-900'>Email envoyé avec succès !</h2>
              <p className='mb-2 leading-relaxed text-gray-600'>Un lien de réinitialisation a été envoyé à</p>
              <p className='text-lg font-semibold text-[#1DBF73] mb-6'>{email}</p>
              <div className='bg-[#1DBF73]/10 border border-[#1DBF73]/20 rounded-xl p-4 mb-6'>
                <p className='text-sm text-gray-700'>
                  💡 <span className='font-medium'>Conseil :</span> Vérifiez également votre dossier spam.
                </p>
              </div>
              <Link to='/login'>
                <motion.button
        ...
        {!success && (
          <p className='mt-6 text-xs text-center text-gray-500'>
            ...
            <button onClick={handleSubmit} className='text-[#1DBF73] hover:text-[#09B1BA] font-medium transition-colors'>
              Renvoyer
            </button>
          </p>
        )}
