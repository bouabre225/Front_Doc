              ...
              <Link to={`/categories/${category.slug}`}>
                ...
                >
                  <div className='relative h-full'>
                    ...
                    {/* Overlay Gradient */}
                    <div className={`absolute inset-0 bg-gradient-to-br ${category.color} transition-opacity duration-300`}></div>
                    
                    {/* Content */}
                    <div className='relative z-10 flex flex-col justify-end h-full p-6 text-white'>
                      <h3 className='mb-1 text-xl font-bold'>{category.name}</h3>
                      <p className='text-sm font-medium text-white/90'>{category.count} équipements</p>
                    </div>
